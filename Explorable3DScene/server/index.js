...
loader.load("https://kevinnewcombe.s3.ca-central-1.amazonaws.com/Skillshare/demo/scene.gltf", function(gltf){
  gltf.scene.rotation.set(0, THREE.Math.degToRad(270), THREE.Math.degToRad(270));
